...
interface BarberNotificationSettingsScreenProps {
  onNavigate?: (screen: string) => void;
  onBack?: () => void;
  barberId?: string; // ID of the barber
}

const BarberNotificationSettingsScreen: React.FC<BarberNotificationSettingsScreenProps> = ({ 
  onNavigate, 
  onBack,
  barberId = 'barber' // Default barber ID, should be passed from parent
}) => {
  ...
  const loadSettings = async () => {
    try {
      setLoading(true);
      const notificationSettings = await getNotificationSettings(barberId, 'barber');
  ...
  const availableNotificationTypes = getAvailableNotificationTypes('barber');
    ...
    return (
      <SafeAreaView style={styles.container}>
        <TopNav 
          title="הגדרות התראות"
          showBackButton={true}
          onBackPress={onBack || (() => onNavigate && onNavigate('barber-dashboard'))}
        />
        ...
        <View style={styles.section}>
          <View style={styles.infoContainer}>
            ...
            <Text style={styles.infoText}>
              כספר, תקבל התראות רק על תורים הקשורים אליך
            </Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.reminderTimesContainer}>
            <Text style={styles.reminderTimesDescription}>
              בחר מתי לקבל תזכורות לפני תורים שלך
            </Text>
...
export default BarberNotificationSettingsScreen;
